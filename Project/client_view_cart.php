...
<body>
    ...
    <button class="btn btn-danger" id='sum'></button>
...
$sum=0;
    ...
    while($row=mysqli_fetch_assoc($sql_res))
    {
        ...
        echo "<div class='bg-info parent mt-5 mx-3'>
                ...
                <a href='client_removecart.php ?pid=$pid'>
                <button class='mybtn3 btn btn-danger'> <i class=' text-white fa fa-trash'></i> </button>
            </a>
...
echo "<script>
    ...
    document.getElementById('sum').innerHTML='Buy Total RS: $sum';
